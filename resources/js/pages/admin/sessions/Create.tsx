...
export default function Create({ session, movies, rooms }: Props) {
    const { data, setData, post, processing, errors } = useForm<SessionForm>(session);
                    ...
                    <CardContent>
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Enregistrement...' : 'Créer la séance'}
                            </Button>
                        </form>
                    </CardContent>
                </Card>
